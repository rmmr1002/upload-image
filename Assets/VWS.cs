...
public class VWS : MonoBehaviour 
{
	...
	public string accessKey= "700c0126b4bd62434ff1cec7583105a219449449";

    public string secretKey= "d636cdac8f09cc9623e5bdf2749e65bc2d08fde5";
    ...
    public void Start()
    {
        ...
        AddTarget("NewTrget", 4, tex, true, "nothing", response =>
        {
